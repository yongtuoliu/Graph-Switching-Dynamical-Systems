...
default = CfgNode({
    ...
    'options': {
        ...
        'obj_modes': ('random_noreplace', (0, 1, 2)),
        # How many pixels to move per frame
        'speed': 2,
        'updates_per_second': 10,
        'max_attempts': 1000,
        'interaction': False,
        'part_interaction': False,
        'fps': 20,
...
config_list = {
    ...
    'balls_occlusion': CfgNode({
        ...
        'options': {
            ...
            'obj_shapes': ('random', ('circle16',)),
            # 'obj_sizes': ('random', (8.0,)),
            'obj_sizes': ('random', (4.0,)),
            'obj_layers': ('random', (0,)),
            'obj_masses': ('random', (1,)),
            # See here https://htmlcolorcodes.com/
            'obj_colors': ('random_noreplace', ('blue', 'red', 'yellow', 'fuchsia', 'aqua')),
            # 'obj_modes': ('random', ('circle', 'shrink-circle', 'explode-cricle')),
            'obj_modes': ('random_noreplace', (0,1,2)),
            'speed': 15, # How many pixels to move per frame 0.15 * 10 = 1.5
            'updates_per_second': 100, # fps
            'max_attempts': 1000,
            'interaction': True,
            'part_interaction': False, # 1: Lotka-Volterra ODE without nointeraction
            'fps': 10,
            'restricted': True, # For the first frame, whether all objects should be within camera
